...
>
    ...
    <div
        x-show="show"
        class="mb-6 bg-white rounded-[2rem] shadow-2xl shadow-slate-900/20 transform transition-all sm:w-full {{ $maxWidth }} sm:mx-auto overflow-hidden border border-stone-100"
        x-transition:enter="ease-out duration-300"
